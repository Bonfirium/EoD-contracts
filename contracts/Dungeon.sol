...
contract Dungeon {
	...
	function get_map() public pure returns (uint8[16][30]) {
		return [
			...
			[3, 3, 3, 5, 3, 3, 3, 3, 3, 2, 3, 2, 3, 2, 3, 2],
			[3, 5, 3, 3, 3, 2, 3, 2, 3, 3, 3, 3, 3, 3, 3, 3],
			[3, 3, 3, 3, 3, 3, 3, 3, 3, 2, 3, 3, 2, 3, 3, 3],
			[3, 5, 3, 3, 2, 3, 2, 3, 3, 3, 3, 3, 3, 3, 3, 4],
			[3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2, 3, 2, 3, 3, 3],
			[3, 2, 3, 2, 3, 3, 3, 2, 3, 3, 3, 3, 3, 3, 3, 2],
			[3, 3, 3, 3, 3, 2, 3, 3, 3, 2, 3, 2, 3, 5, 3, 3],
			[5, 3, 3, 3, 3, 3, 3, 2, 3, 3, 3, 3, 3, 3, 3, 3],
			[3, 3, 2, 3, 3, 3, 3, 3, 3, 2, 3, 3, 3, 3, 3, 2],
			[3, 3, 3, 3, 3, 2, 3, 2, 3, 3, 3, 2, 3, 2, 3, 3],
			[3, 2, 3, 5, 3, 3, 3, 3, 3, 2, 3, 3, 3, 3, 3, 2],
			[3, 3, 3, 3, 3, 2, 3, 2, 3, 3, 3, 2, 3, 2, 3, 3],
			[3, 2, 3, 2, 3, 3, 3, 3, 3, 2, 3, 3, 3, 3, 3, 4],
			[3, 3, 3, 3, 3, 3, 2, 3, 3, 3, 3, 3, 3, 3, 3, 3],
			[3, 3, 3, 2, 3, 3, 3, 3, 3, 2, 3, 3, 2, 3, 5, 3],
			[4, 3, 3, 3, 3, 3, 2, 3, 3, 3, 3, 3, 3, 3, 3, 3],
			[3, 3, 2, 3, 2, 3, 3, 3, 2, 3, 2, 3, 5, 3, 2, 3],
			[3, 3, 3, 3, 3, 3, 2, 3, 3, 3, 3, 3, 3, 3, 3, 3],
			[4, 3, 2, 3, 3, 3, 3, 3, 3, 3, 2, 3, 3, 2, 3, 2],
			[3, 3, 3, 3, 3, 2, 3, 3, 2, 3, 3, 3, 3, 3, 3, 3],
			[3, 3, 3, 2, 3, 3, 3, 3, 3, 3, 5, 3, 2, 3, 2, 3],
			[3, 2, 3, 3, 3, 2, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3],
			[3, 3, 3, 3, 3, 3, 3, 2, 3, 3, 3, 3, 2, 3, 2, 3],
			[2, 3, 5, 3, 2, 3, 3, 3, 3, 3, 2, 3, 3, 3, 3, 3],
